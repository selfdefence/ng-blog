...
app.config(['PopularPostProvider', 'LastContentProvider', 'ArticleProvider', 'DocumentProvider', 'PostProvider',
        function (PopularPostProvider, LastContentProvider, ArticleProvider, DocumentProvider, PostProvider) {
    ...
    PostProvider.setRequest({method:'GET', url: '/post'});
}]);
